...
export default function CampaignPerformance() {
    ...
    const [funnelData, setFunnelData]         = useState({ impressions: '', clicks: '', conversions: '', impToClick: '', clickToConv: '' });
    ...
    return (
        <Layout>
            <div className="mb-6">
                <h1 className="text-2xl font-bold mb-1 text-gray-800">{t('campaignTitle')}</h1>
                <p className="text-sm text-gray-500">{t('campaignDesc')}</p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
                <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                    <div className="flex justify-between items-start mb-4">
                        <span className="text-xs font-medium text-gray-400">{t('totalImpressions')}</span>
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                    <div className="flex justify-between items-start mb-4">
                        <span className="text-xs font-medium text-gray-400">{t('totalClicks')}</span>
                        <div className="w-6 h-6 bg-blue-50 text-blue-500 rounded-lg flex items-center justify-center text-xs">🖱️</div>
                    </div>
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                    <div className="flex justify-between items-start mb-4">
                        <span className="text-xs font-medium text-gray-400">{t('avgCtr')}</span>
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                    <div className="flex justify-between items-start mb-4">
                        <span className="text-xs font-medium text-gray-400">{t('conversions')}</span>
                        <div className="w-6 h-6 bg-blue-50 text-blue-500 rounded-lg flex items-center justify-center text-xs">📈</div>
                    </div>
                ...
                <div className="bg-[#635BFF] text-white rounded-2xl p-5 shadow-md shadow-indigo-100">
                    <div className="flex justify-between items-start mb-4">
                        <span className="text-xs font-medium opacity-80">{t('avgRoas')}</span>
                        <div className="w-6 h-6 bg-white/20 rounded-lg flex items-center justify-center text-xs font-bold">$</div>
                    </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8">
                <h2 className="text-sm font-bold text-gray-800 mb-1">{t('funnel')}</h2>
                <p className="text-xs text-gray-400 mb-6">{t('journeyFunnel')}</p>
                <div className="flex flex-col gap-3 max-w-4xl mx-auto mb-6">
                    <div className="bg-gradient-to-r from-[#4285F4] to-[#60A5FA] rounded-xl p-5 text-white flex justify-between items-center">
                        <span className="text-sm font-bold">{t('totalImpressions')}</span>
                    ...
                    <div className="bg-gradient-to-r from-[#7C3AED] to-[#A78BFA] rounded-xl p-4 text-white flex justify-between items-center w-[85%] mx-auto">
                        <span className="text-sm font-bold">{t('totalClicks')}</span>
                    ...
                    <div className="bg-gradient-to-r from-[#0D9488] to-[#2DD4BF] rounded-xl p-3 text-white flex justify-between items-center w-[70%] mx-auto">
                        <span className="text-sm font-bold">{t('conversions')}</span>
                        <span className="text-lg font-black">{funnelData.conversions}</span>
                    </div>
                </div>
                <div className="grid grid-cols-2 gap-4 max-w-2xl mx-auto">
                    <div className="bg-gray-50 rounded-xl p-3 border border-gray-100 text-center">
                        <p className="text-xs text-gray-400">{t('impressionToClick')}</p>
                        <p className="text-base font-bold text-gray-700">{funnelData.impToClick}</p>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-3 border border-gray-100 text-center">
                        <p className="text-xs text-gray-400">{t('clickToConversion')}</p>
                        <p className="text-base font-bold text-gray-700">{funnelData.clickToConv}</p>
                    </div>
                </div>
            </div>

            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8">
                <h2 className="text-sm font-bold text-gray-800 mb-1">{t('activeCampaigns')}</h2>
                <p className="text-xs text-gray-400 mb-6">{t('detailedCampaignMetrics')}</p>
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-gray-100 text-xs font-bold text-gray-400">
                                <th className="py-3 px-2">{t('campaignCol')}</th>
                                <th className="py-3 px-2 text-center">{t('totalImpressions')}</th>
                                <th className="py-3 px-2 text-center">{t('totalClicks')}</th>
                                <th className="py-3 px-2 text-center">CTR</th>
                                <th className="py-3 px-2 text-center">{t('conversions')}</th>
                                <th className="py-3 px-2 text-center">{t('spendCol')}</th>
                                <th className="py-3 px-2 text-center">{t('revenueCol')}</th>
                        ...
                        <tbody className="text-xs">
                            {campaigns.map((item, index) => (
                                <tr key={index} className="border-b border-gray-50 last:border-0">
                                    ...
                                    <td className="py-4 px-2 text-center">{item.impressions}</td>
