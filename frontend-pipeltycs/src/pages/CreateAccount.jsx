    ...
    return(
        <div className='min-h-screen bg-[#F9FBFD] flex items-center justify-center p-8 gap-16'>
            <div className='flex flex-col items-center w-full max-w-sm text-center'>
                ...
                <h1 className='text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#6155F5] to-[#CB30E0] mb-3'>Join Pipeltycs
                </h1>
                <p className='text-gray-500 text-sm mb-10 px-4'>Start tracking your sales across all platforms in one unified dashboard</p>
                ...
                <div className='flex flex-col gap-4 w-full px-4 mb-1'>
                    <div className='flex items-center gap-4 bg-white px-5 py-3.5 rounded-xl border border-gray-100 shadow-sm'>
                        <div className='w-8 h-8 flex-shrink-0 bg-orange-50 rounded-lg flex items-center justify-center'>
                            ...
                            <span className='text-sm font-medium text-gray-700 text-left'>Real time analytics across all platform</span>
                    </div>    
                </div>
                <div className='flex flex-col gap-4 w-full px-4 mb-1'>
                    <div className='flex items-center gap-4 bg-white px-5 py-3.5 rounded-xl border border-gray-100 shadow-sm'>
                        <div className='w-8 h-8 flex-shrink-0 bg-orange-50 rounded-lg flex items-center justify-center'>
                            ...
                            <span className='text-sm font-medium text-gray-700 text-left'>AI Powered sales recommendations </span>
                    </div>    
                </div>
                <div className='flex flex-col gap-4 w-full px-4 mb-1'>
                    <div className='flex items-center gap-4 bg-white px-5 py-3.5 rounded-xl border border-gray-100 shadow-sm'>
                        <div className='w-8 h-8 flex-shrink-0 bg-orange-50 rounded-lg flex items-center justify-center'>
                            ...
                            <span className='text-sm font-medium text-gray-700 text-left'>Multi currency & multi languange support</span>
                    </div>    
                </div>
            </div>
            ...
            <div className='w-full max-w-md bg-white rounded-2xl shadow-xl p-8'>
                <div className='mb-6'>
                    ...
                    <p className='text-gray-500 text-sm mt-1'>Start your analytics journey today</p>
                </div>
                <form className='space-y-4'>
                    <div>
                        ...
                        <div className='relative'>
                            ...
                            <input type="text" placeholder='Muktabar Zaki' className='w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#635BFF] transition-colors' />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className='relative'>
                            ...
                            <input type="Email" placeholder='your@email.com' className='w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#635BFF] transition-colors' />
                        </div>
                    </div>
                    <div>
                        <label className='block text-xs font-medium text-gray-700 mb-1'>Business Category</label>
                        <div className='relative'>
                            <img src={IconKategory} alt="IkonKategory" className="absolute left-3 top-2.5 w-5 h-5 opacity-50 object-contain" />
                            <select className='w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#635BFF] transition-colors appearance-none text-gray-500'>
                    ...
                    <div>
                        ...
                        <div className='relative'>
                             <img src={IconKunci} alt="IkonKunci" className="absolute left-3 top-2.5 w-5 h-5 opacity-50 object-contain" />
                             <input type="password" placeholder='*******' className='w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#635BFF] transition-colors' />  
                        </div>                        
                    </div>
                    <div>
